...
const TransactionHistory = () => {
  ...
  return (
   <>
    {array.map((item)=>{
        return(
            <div style={{background: 'linear-gradient(98.97deg, #2C2C2E 1.64%, rgba(0, 0, 0, 0) 102.85%)',
                border: '1px solid #313131',
                borderRadius: '12px', color:"white", padding:"10px", margin:"5px", fontFamily:"Poppins"}}>
                <div style={{fontFamily:"Poppins"}} className='d-flex justify-content-between align-items-center'>
                    <div className='d-flex align-items-center gap-2'>
                    <p style={{fontSize:"8px", color:"#47DDFC", marginBottom:"0px"}}>34% <Icon icon="akar-icons:arrow-up" /></p>
