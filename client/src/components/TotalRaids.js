  ...
  return (
    <>
      ...
      {arr.map((item) => {
        return (
          <>
          {/* <Typography sx={{borderRadius: '10px', background: 'rgba(255, 255, 255, 0.03)',
                        boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)',
                        backdropFilter: 'blur(2px)', width: '53p',
                        height: '53px'}}>
              ...
              <CardHeader
                sx={{
                  ...
                  width: "100%",
                  color: "white",
                  background: 'linear-gradient(98.97deg, #2C2C2E 1.64%, rgba(0, 0, 0, 0) 102.85%)',
