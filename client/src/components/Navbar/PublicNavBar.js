      ...
      >
        ...
        >
          <Grid spacing={6} item className="header_left">
            ...
            >
              <Icon style={{ fontSize: "30px" }} icon="dashicons:menu" />
            </Typography>
            <Grid container sx={{ marginLeft: "70px" }}>
              <Grid item xs={1}>
                <Icon className="wallet-icon" icon="clarity:wallet-line" />
              </Grid>
            </Grid>
          </Grid>
          <Grid item className="header_right">
            <Grid container spacing={5} alignItems="center">
              <Grid item xs={1}>
                <Icon className="header-icon" icon="radix-icons:discord-logo" />
              </Grid>
              <Grid item xs={1}>
                <Icon className="header-icon" icon="ant-design:user-outlined" />
              </Grid>
              <Grid item xs={3}>
