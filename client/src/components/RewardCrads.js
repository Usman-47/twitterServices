            ...
            <Grid item xs={11} md={6} xl={4} padding="5px">
              <Card className="rewards_card" sx={{ width:"100%", }}>
                ...
                <Typography
                  ...
                  component="div"
                >
                  {i === 0 && <img width={"40px"} height={"40px"} src={item.src} alt="solana" /> }
                  {i === 1 && <img width={"30px"} src={item.src} alt="solana" /> }
                  {i === 2 && <img width={"45px"} src={item.src} alt="solana" /> }
                  <Typography gutterBottom variant="h6" marginTop="10px" color="white" component="div">
                    {item.title}
                  </Typography>
                </Typography>
                ...
                <Typography sx={{color:"white",}}>
                  0.050 sol <br />
                  <span sx={{fontSize: '10.9755px', color:"#47DDFC !important"}}>12.2%</span>
                </Typography>
