...
const arr = [{
  title:"Total Raids", no: "$220"
},
{
  title:"Total Reward", no: "0.050 sol"
},
{
  title:"Avg. SOL per Raid", no: "0.025 sol"
},
];
          ...
          <>
            ...
            >
              <div className="d-flex gap-2 align-items-center">
                <div>
                <p style={{fontSize:"36px"}}><Icon color="#47DDFC" icon="raphael:linechart" /></p>
                </div>
               <div className="">
                <p style={{fontSize:"14px", marginBottom:"0px"}}>{item.title}</p>
                <p style={{fontSize:"30px", marginBottom:"0px"}}>{item.no}</p> 
               </div>
